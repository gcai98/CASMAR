...
def get_args_parser():
    ...
    parser.add_argument('--cond_scale', type=int, default=8)
    ...
    parser.add_argument('--output_dir', default='./output_dir/casmar_base_test',
...
def main(args):
    ...
    model = casmar.__dict__[args.model](
